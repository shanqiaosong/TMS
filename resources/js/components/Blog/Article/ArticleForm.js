...
import { Form, Input, Button, Upload, message, Modal, Badge, Select, Switch, Popover } from 'antd';
...
export class ArticleForm extends React.Component {
          ...
          (
            <FormItem
              ...
              <a href="http://rexxars.github.io/react-markdown/" target="_blank">
                <Button size="small" style={{marginLeft:20}}>Markdown 语法示例</Button>
              </a>
              {
                this.state.preview?
                (
  ...
  uploadFn = (param) => {
      //alert('upload')
    const serverURL = '/api/1.0/blog/upload'
